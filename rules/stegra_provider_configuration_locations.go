...
func NewStegraProviderConfigurationLocationsRule() *StegraProviderConfigurationLocationsRule { return &StegraProviderConfigurationLocationsRule{} }
func (r *StegraProviderConfigurationLocationsRule) Name() string { return "stegra_provider_configuration_locations" }
    ...
    for filename, file := range files {
        ...
        if !isAllowed {
            for _, blk := range body.Blocks {
                ...
                if err := runner.EmitIssue(r, msg, issueRange); err != nil { return err }
            }
        }
    }
