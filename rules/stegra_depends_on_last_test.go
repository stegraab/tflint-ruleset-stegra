...
`,
        ...
        {
            Name: "module invalid - attribute after depends_on",
            File: "modules.tf",
            Content: `
module "mod" {
  source     = "./m"
            ...
            Expected: helper.Issues{
                {
                    Rule:    NewStegraDependsOnLastRule(),
                    Message: "depends_on must be the last attribute in this block",
                    Range:   hcl.Range{Filename: "modules.tf", Start: hcl.Pos{Line: 4, Column: 3}, End: hcl.Pos{Line: 4, Column: 37}},
                },
            },
        },
        {
...
func Test_StegraDependsOnLastRule_Fix_MovesToEnd(t *testing.T) {
    rule := NewStegraDependsOnLastRule()
